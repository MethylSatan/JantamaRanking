        ...
        app.NetAgent.sendReq2Lobby(
            ...
            function(i, record) {
                ...
                download(
                    ...
                    ((new Date(record.head.end_time * 1000)).toLocaleDateString("ja-JP" ,{ year : "numeric", month : "2-digit", day : "2-digit" }) + "-" + (new Date(record.head.end_time * 1000)).toLocaleTimeString("ja-JP" ,{ hour : "2-digit", minute : "2-digit", second : "2-digit" }) + "_" + results["rule"]["disp"] + ".json").replace(/[ \/]/g,"_"),
                    PRETTY ?
